        ...
        apiData = apiData.concat(posts.map(function (post) {
            ...
            return {
                ...
                data: JSON.stringify({
                    ...
                    color: ('color' in post && post.color) || null,
                    cover: ('cover' in post && post.cover) || fetchCover(post.content),
        ...
        apiData = apiData.concat(site.pages.data.map(function (page) {
            ...
            return {
                ...
                data: JSON.stringify({
                    ...
                    path: path,
                    color: ('color' in page && page.color) || null,
                    cover: ('cover' in page && page.cover) || fetchCover(page.content),
